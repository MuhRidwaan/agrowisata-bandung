        ...
        fetch(@json(url('/pembayaran/status')) + '/' + encodeURIComponent(data.booking_code), {
            ...
            .then(function(result) {
                ...
                wrapper.innerHTML =
                    ...
                    '<div style="font-weight:700;margin:2px 0 10px;">Kode: ' + result.booking_code +
                    '</div>' +
                    '<a href="' + result.resume_url +
                    '" style="display:inline-block;background:#198754;color:#fff;text-decoration:none;padding:8px 12px;border-radius:8px;font-size:13px;">Lanjutkan Pembayaran</a>' +
